...
function downloadChat(){
  const text=Array.from(document.querySelectorAll('.message .bubble .text'))
...
document.addEventListener('click',async e=>{
  if(e.target.classList.contains('reaction')){
    ...
    fetch('/react',{
      ...
      body:'messageId='+encodeURIComponent(messageId)+'&emoji='+encodeURIComponent(emoji)
